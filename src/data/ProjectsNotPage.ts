...
interface ProjectState {Projects : Project[]}
...
export const projects : ProjectState = {Projects :[
  {
    id: 1,
    title: "To Do App",
    Photo: "ToDoApp.png",
    ...
    description:
      ...
      technologies:["React","Redux Toolkit","shadcn/ui","TailwindCSS","TypeScript"],
  ...
  },
  {
    ...
    description:
      ...
      technologies:["React","TailwindCSS","TypeScript","Vitest testy jednostkowe","FETCH","local Storage","Framer Motion","React Router"]
, GitHub:"https://github.com/caps-ctrl/quizgame"  },
  {
    ...
    description:
      ...
      technologies:["React","Redux Toolkit","shadcn/ui","TailwindCSS","TypeScript","Zod","React Hook Form","React Router"]
